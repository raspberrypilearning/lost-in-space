...
<pre><code>var quiz = [
    {
        "question"      :   "The scripts shown each move a sprite using a loop. Which of the scripts is the odd one out?",
    ...
    },
    {
        ...
        "correct"       :   "C",
        "explanation"   :   "The sprite needs to glide using a forever loop, and change it's x position."
    },
    {
        ...
        "correct"       :   "15",
        "explanation"   :   "You need to multiply the number of repeats in each loop together.",
    },
